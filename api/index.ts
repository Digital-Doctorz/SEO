  ...
  const serpFeatures = [
    {
      ...
      opportunity: "Answer the query in a 40Ã¢â‚¬â€œ60 word definition paragraph under an H2.",
    ...
    },
    {
      ...
      actionability: "Expand FAQ section with 4Ã¢â‚¬â€œ6 PAA-style questions.",
    },
    {
    ...
    },
    {
      ...
      actionability: "Publish a 3Ã¢â‚¬â€œ5 min YouTube walkthrough with chapters + transcript.",
    },
  ];
  ...
  const backlinkOpportunities = [
    {
      ...
      actionPlan: "Draft outline Ã¢â€ â€™ pitch editor Ã¢â€ â€™ publish with 1 dofollow contextual link.",
    },
    {
...
app.post("/api/generate-blog", async (req, res) => {
  const domain = resolveDomain(req.body);
  const { topic, keyword, secondaryKeywords = [], wordCount = 2000, audience = "", tone = "" } = req.body || {};
  if (!domain || domain === "target-website.com") {

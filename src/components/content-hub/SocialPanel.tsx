          ...
          <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6 self-start">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                >
                  <option value="General Patients & Healthcare Seekers">Ã°Å¸ÂÂ¥ Patients & Healthcare Seekers</option>
                  <option value="Marketing Managers & SEOs">Ã°Å¸â€œË† Marketing Managers & SEOs</option>
                  <option value="B2B Clients & Executives">Ã°Å¸â€˜â€ B2B Clients & Executives</option>
                  <option value="SaaS Founders & Tech Leaders">Ã°Å¸â€™Â» SaaS Founders & Tech Leaders</option>
                  <option value="Small Business Owners">Ã°Å¸ÂÂª Small Business Owners</option>
                  <option value="General Public">Ã°Å¸â€˜Â¥ General Public</option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full text-sm rounded-xl border border-slate-200 px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 font-semibold bg-white cursor-pointer text-slate-700"
                >
                  <option value="Engagement">Ã°Å¸Â¤Â Drive Community Engagement</option>
                  <option value="Education">Ã°Å¸Å½â€œ Share Value & Educate</option>
                  <option value="Conversion">Ã°Å¸Å½Â¯ Lead Generation & Conversion</option>
                  <option value="Awareness">Ã°Å¸â€œÂ¢ Brand Awareness & Reach</option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full text-sm rounded-xl border border-slate-200 px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 font-semibold bg-white cursor-pointer text-slate-700"
                >
                  <option value="Empathetic & Warm">Ã°Å¸Å’Â¸ Empathetic & Warm (Health & Wellness)</option>
                  <option value="Authoritative & Analytical">Ã°Å¸â€ºÂ¡Ã¯Â¸Â Authoritative & Analytical</option>
                  <option value="Casual & Friendly">Ã°Å¸â€™Â¬ Casual & Friendly</option>
                  <option value="Technical & Precise">Ã°Å¸â€Â¬ Technical & Precise</option>
                  <option value="Bold & Opinionated">Ã°Å¸â€Â¥ Bold & Opinionated</option>
                </select>
              </div>
              ...
              >
                ...
                <div className="flex border-b border-slate-100 pb-px gap-1 overflow-x-auto">
                  {(["post", "metadata", "seo", "schema"] as const).map((tab) => (
                    ...
                    >
                      {tab === "post" && "Ã°Å¸â€œÂ Ready-to-Publish Copy"}
                      {tab === "metadata" && "Ã°Å¸â€œâ€¦ Timing & Engagement"}
                      {tab === "seo" && "Ã°Å¸Å½Â¯ Keyword & Compliance"}
                      {tab === "schema" && "Ã°Å¸â€œÅ  Social Schema LD"}
                    </button>
                  ))}
                </div>
